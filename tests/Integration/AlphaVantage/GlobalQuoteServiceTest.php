...
class GlobalQuoteServiceTest extends KernelTestCase
{
    ...
    private AlphaVantageClientMock $alphaVantageClient;
    ...
    protected function setUp(): void
    {
        ...
        $this->alphaVantageClient = $container->get(AlphaVantageClientInterface::class);
    }
    ...
    public function testNotFetchedTodayButLatestTradingDayExistsInDB(): void
    {
        ...
        $latestTradingDay = $this->alphaVantageClient->getLatestTradingDay();
